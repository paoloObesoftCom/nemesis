...
eEPGStyleSelector::eEPGStyleSelector(int ssel)
		:eListBoxWindow<eListBoxEntryText>(_("EPG Style"), 8, 350, true)
		,ssel(ssel)
{
...
void eEPGStyleSelector::init_eEPGStyleSelector()
{
	...
	eString plugName;
	if ( plugins.execPluginByName("mv.cfg",true) == "OK"
		|| plugins.execPluginByName("_mv.cfg",true) == "OK" )
		{	plugName = nemTool::getInstance()->getPlugName("/var/tuxbox/plugins/mv.cfg");
			if (plugName == "None") 
				plugName = "MVEpg";
			sel[4] = new eListBoxEntryText(&list,plugName.c_str(), (void*)5, 0, _("open external plugin EPG") );
		}
	if ( plugins.execPluginByName("epgui.cfg",true) == "OK"
		|| plugins.execPluginByName("_epgui.cfg",true) == "OK" )
		{	plugName = nemTool::getInstance()->getPlugName("/var/tuxbox/plugins/epgui.cfg");
			if (plugName == "None") 
				plugName = "EPGui";
			sel[5] = new eListBoxEntryText(&list,plugName.c_str(), (void*)6, 0, _("open external plugin EPG") );
		}
	if ( plugins.execPluginByName("weekepg.cfg",true) == "OK"
		|| plugins.execPluginByName("_weekepg.cfg",true) == "OK" )
		{	plugName = nemTool::getInstance()->getPlugName("/var/tuxbox/plugins/weekepg.cfg");
			if (plugName == "None") 
				plugName = "WeekEPG";
			sel[6] = new eListBoxEntryText(&list,plugName.c_str(), (void*)7, 0, _("open external plugin EPG") );
		}
	if ( plugins.execPluginByName("epgfind.cfg",true) == "OK"
		|| plugins.execPluginByName("_epgfind.cfg",true) == "OK" )
		{	plugName = nemTool::getInstance()->getPlugName("/var/tuxbox/plugins/epgfind.cfg");
			if (plugName == "None") 
				plugName = "EPG Find";
			sel[7] = new eListBoxEntryText(&list,plugName.c_str(), (void*)8, 0, _("open external plugin EPG") );
		}

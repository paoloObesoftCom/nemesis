...
class TimerEntry(Screen, ConfigListScreen):
	...
	def createConfig(self):
			...
			justplay_default = {0: "record", 1: "zap", 2: "epg"}[justplay]
			tmp_dir = self.timer.dirname or defaultMoviePath()
			if not harddiskmanager.inside_mountpoint(tmp_dir) and justplay == 0:
				justplay_default = {0: "record", 1: "zap", 2: "epg"}[1]
			self.timerentry_justplay = ConfigSelection(choices = [("zap", _("zap")), ("record", _("record")), ("epg", _("Download EPG"))], default = justplay_default)

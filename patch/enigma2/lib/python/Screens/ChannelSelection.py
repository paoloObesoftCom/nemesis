...
from Nemesis.nemesisTool import editBlacklist
...
class ChannelContextMenu(Screen):
	def __init__(self, session, csel):
		...
		self.channelToManage = csel.getCurrentSelection().toString()
	...
	def addToEpgBL(self):
		t.add(self.channelToManage)
		epg.InitEPGBlock()
		self.close(False)
		
	def removeFromEpgBL(self):
		t.remove(self.channelToManage)
		epg.InitEPGBlock()
		self.close(False)

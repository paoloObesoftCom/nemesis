...
from Nemesis.nemesisBluePanel import nemesisBluePanelOpen
from Nemesis.nemesisBluePanel import nemesisPluginsPanelOpen
from Nemesis.nemesisEpgPanel import nemesisEpgPanelOpen

class InfoBar(InfoBarBase, InfoBarShowHide,
	InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarEPG, InfoBarRdsDecoder, nemesisBluePanelOpen, nemesisEpgPanelOpen, nemesisPluginsPanelOpen,
